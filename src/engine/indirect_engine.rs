...
use crate::engine::buffers::{uniform_buffer::{UniformBuffer, SetUniformBuffer}, storage_buffer::StorageBuffer};
...
impl IndirectEngine {
    ...
    pub fn update<T>(
        ...
        device: &wgpu::Device, 
        camera: &T, 
        _entity_data : &entity_data::EntityData
    ) 
        where T : Camera
    {
    ...
    pub fn render(
        ...
        rpass.draw_model_indirect(&entity_data.indirect_models[0]);
    }
}
